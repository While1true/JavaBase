...
public class InputUtils {
    ...
    public static void hideKeyboard(EditText editText) {
        InputMethodManager service = (InputMethodManager) AppContext.get().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public static void hideKeyboard(Activity context) {
        InputMethodManager inputMethodManager = (InputMethodManager) AppContext.get().getSystemService(Context.INPUT_METHOD_SERVICE);
        try {
    ...
    public static void hideKeyboard(Dialog dialog) {
        InputMethodManager manager= (InputMethodManager) AppContext.get().getSystemService(Context.INPUT_METHOD_SERVICE);
